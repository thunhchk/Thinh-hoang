...
Button.Image = "rbxassetid://107254750142437"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/WWPQpucP")) 
        end
})
Tabs.Info:AddButton({
    Title="nguyễn phước thịnh",
    Description="Youtube",
    Callback=function()
...
Tabs.Info:AddParagraph({
    Title="nguyễn phước thịnh-phạm minh phàm",
    Content="Credits"
})
local executorName
        ...
        if _G.FastAttackVxeze_Mode then
            pcall(function()
                if _G.FastAttackVxeze_Mode=="Super Fast Attack" then
                    _G.Fast_Delay=0.0000000000000000000000000001 
                end
            end)
        end
    end
